...
public partial class EnemyHealthModel
{
...
public partial class EnemyHealthModel : RealtimeModel
{
    public int health
    {
        get
    ...
    public delegate void PropertyChangedHandler<in T>(EnemyHealthModel model, T value);
    ...
    public EnemyHealthModel() : base(null)
    {
